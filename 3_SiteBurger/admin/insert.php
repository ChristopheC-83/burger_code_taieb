...
if (!empty($_POST)) {
    ...
    // les images seront uploadées dans le dossier (ici) images avec un nom donné par le user
    $image              = checkInput($_FILES["image"]["name"]);
    // on définit le dossier de l'image et du dossier récepteur
    $imagePath          = '../images/' . basename($image);
    // il nous faut également son extension
