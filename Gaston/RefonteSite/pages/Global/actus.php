...
<div class='row no-gutters align-items-center' style="min-height:300px;">
    <div class="col-12 col-md-3 text-center">
        <img src="../../sources/images/Animaux/Chat/framboise/framboise.jpg" alt="Framboise" style="max-height:280px" />
    </div>
...
<div class='row no-gutters align-items-center' style="min-height:300px;">
    <div class="col-12 col-md-3 text-center">
        <img src="../../sources/images/Animaux/chien/fonzie/fonzie.jpg" alt="Framboise" style="max-height:280px" />
    </div>
    <div class="col-12 col-md-9">
