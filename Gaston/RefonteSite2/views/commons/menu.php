    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item perso_ColorVertMenu" href="?page=actus">Evénements</a>
                <a class="dropdown-item perso_ColorVertMenu" href="?page=actus">Nos actions au quotidien</a>
            </div>
        </li>
        <li class="nav-item dropdown">
